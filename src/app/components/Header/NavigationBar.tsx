...
import FormSearchBar, { Item } from "./FormSearchBar";

import styles from "./NavigationBar.module.css";
import DropdownList from "./DropdownList";

const NavigationBar = () => {
  const [sharedFilteredItems, setSharedFilteredItems] = useState<Item[]>([]);
  const [showDropdown, setShowDropdown] = useState<boolean>(false);

  const handleFilteredItemsChange = (filteredItems: Item[]) => {
    setSharedFilteredItems(filteredItems);
  ...
  return (
    <header className={styles.header_container}>
      <div className={styles.header_background}>
        <div className={styles.header_flex}>
          <div className={styles.logo}>
            <a href="/">
              <img src="/Kabum Logo.svg" alt="kabumlogo" />
            </a>
          </div>
          <FormSearchBar onFilteredItemsChange={handleFilteredItemsChange} />
      ...
      <DropdownList filteredItems={sharedFilteredItems} />
    </header>
  );
};
